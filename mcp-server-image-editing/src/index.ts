  ...
  private setupHandlers() {
      ...
      const tools = [
        {
          name: "imagen_crop",
          description:
            "Crop an image to a specific rectangular region. Use this when the user wants to focus on part of an image or remove edges.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to crop. Use 'current' for the most recently generated image, or a specific image ID.",
              },
              x: {
                type: "number",
                description:
        ...
        },
        {
          name: "imagen_resize",
          description:
            "Resize an image to specific dimensions. Use this when the user wants to change the size of an image.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to resize. Use 'current' for the most recently generated image.",
              },
              width: {
                type: "number",
        ...
        },
        {
          name: "imagen_adjust",
          description:
            "Adjust image properties like brightness, contrast, saturation, and hue. Use this when the user wants to improve or modify the appearance of an image.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to adjust. Use 'current' for the most recently generated image.",
              },
              brightness: {
                type: "number",
                description:
        ...
        },
        {
          name: "imagen_filter",
          description:
            "Apply visual filters or effects to an image. Use this when the user wants to change the style or add effects like blur, sharpen, grayscale, etc.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to filter. Use 'current' for the most recently generated image.",
              },
              filter: {
                type: "string",
              ...
              intensity: {
                type: "number",
                description:
                  "Filter intensity (0-100). For blur: radius in pixels. For sharpen: strength. Default: 50",
              },
            },
        ...
        },
        {
          name: "imagen_rotate",
          description:
            "Rotate or flip an image. Use this when the user wants to change the orientation.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to rotate. Use 'current' for the most recently generated image.",
              },
              angle: {
                type: "number",
        ...
        },
        {
          name: "imagen_format",
          description:
            "Convert image format (PNG, JPEG, WebP, etc.). Use this when the user wants to change the file format.",
          inputSchema: {
            type: "object",
            properties: {
              imageId: {
                type: "string",
                description:
                  "ID of the image to convert. Use 'current' for the most recently generated image.",
              },
              format: {
                type: "string",
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      ...
      try {
        ...
        const resolvedImage = await this.imageResolver.resolve(
        ...
        if (resolvedImage.path) {
          ...
          throw new Error(
            "IMAGE_RESOLUTION_FAILED: No path or base64 available"
          );
        }
        ...
        switch (name) {
          case "imagen_crop": {
            ...
            result = await this.imageTools.crop(
              inputBuffer,
              x as number,
              y as number,
              width as number,
          ...
          case "imagen_adjust": {
            ...
            result = await this.imageTools.adjust(inputBuffer, {
              ...
              contrast: contrast as number | undefined,
              saturation: saturation as number | undefined,
              hue: hue as number | undefined,
            });
            editType = "adjust";
          ...
          case "imagen_rotate": {
            ...
            result = await this.imageTools.rotate(
              inputBuffer,
              angle as number | undefined,
              flip as string | undefined
            );
            editType = "rotate";
            editPrompt = angle
          ...
          case "imagen_format": {
            ...
            outputMimeType = this.imageTools.getMimeTypeForFormat(
              format as string
            );
            editType = "format";
        ...
        const { path: outputPath } = await writeImageAtomically(
          result,
          outputMimeType
        );
