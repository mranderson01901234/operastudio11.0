...
export class BrowserTools {
    ...
    page = null;
    downloadPath;
    constructor(security, downloadPath) {
     ...
     */
    async executeActions(url, actions, headless = true, timeout = 300000 // 5 minutes default
    ) {
        try {
            // Launch browser
     ...
     */
    async interactiveDownload(url, formFills, downloadButtonSelector, saveAs, headless = true) {
        const actions = [
            {
                type: "navigate",
                url,
