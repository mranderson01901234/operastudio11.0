...
class OperaStudioMCPServer {
  ...
  constructor(mode: SecurityMode = "SAFE") {
    this.mode = mode;
      ...
      try {
        switch (name) {
          ...
          case "cmd_execute": {
            ...
            const timeout = (args.timeout as number) || 300000; // 5 minutes for installations
...
const mode = (process.argv[2] as SecurityMode) || (process.env.MCP_MODE as SecurityMode) || "SAFE";
